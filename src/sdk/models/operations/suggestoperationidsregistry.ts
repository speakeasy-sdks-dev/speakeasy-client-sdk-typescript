...
> = z.object({
  ...
  SuggestOperationIDsOpts: shared.SuggestOperationIDsOpts$inboundSchema
    .optional(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  ...
  limit: z.number().optional(),
  suggestOperationIDsOpts: shared.SuggestOperationIDsOpts$outboundSchema
    .optional(),
}).transform((v) => {
  return remap$(v, {
...
export namespace SuggestOperationIDsRegistryRequest$ {
  ...
  export const outboundSchema =
    SuggestOperationIDsRegistryRequest$outboundSchema;
