...
```typescript
import { SpeakeasyCore } from "@speakeasy-api/speakeasy-client-sdk-typescript/core.js";
import { authGetWorkspaceAccess } from "@speakeasy-api/speakeasy-client-sdk-typescript/funcs/authGetWorkspaceAccess.js";
...
async function run() {
  const res = await authGetWorkspaceAccess(speakeasy, {});
